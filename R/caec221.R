...
dace221 <- read_tsv("/home/xut/Documents/udaviz/R/studio/udafutec/data/ec20221.csv")
...
tj1 = data.frame("EQUIPOS" =
                 ...
                 "PJ" =
                   c(NROW(dbsc1$Jornada), NROW(dldu1$Jornada), NROW(didv1$Jornada), NROW(deme1$Jornada),
                     NROW(dauc1$Jornada), NROW(dmac1$Jornada), NROW(dore1$Jornada), NROW(dcue1$Jornada),
                     NROW(dgci1$Jornada), NROW(dcum1$Jornada), NROW(duca1$Jornada), NROW(dnoc1$Jornada),
...
tj2 = data.frame("EQUIPOS" =
                 ...
                 "PJ" =
                   c(NROW(dbsc2$Jornada), NROW(dldu2$Jornada), NROW(didv2$Jornada), NROW(deme2$Jornada),
                     NROW(dauc2$Jornada), NROW(dmac2$Jornada), NROW(dore2$Jornada), NROW(dcue2$Jornada),
                     NROW(dgci2$Jornada), NROW(dcum2$Jornada), NROW(duca2$Jornada), NROW(dnoc2$Jornada),
...
tjx = select(tjn, "EQUIPOS", "J1", "J2", "J3", "J4", "J5", "J6","J7", "J8", "J9", "J10", "J11", "J12", "J13", "J14", "J15")
tjx <- gather(tjx,
              key = "variable",
              value = "value",
              J1:J15)

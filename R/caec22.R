...
tjx = select(tjj, "EQUIPOS", "J1", "J2", "J3", "J4", "J5", "J6","J7", "J8", "J9", "J10", "J11")
tjx <- gather(tjx,
               key = "variable",
               value = "value",
               J1:J11)
...
write.table(tjx,"tj1_11.txt",sep="\t",row.names=FALSE)
...
#tjx$variable <- as.numeric(tjx$variable)

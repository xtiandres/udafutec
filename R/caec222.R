# CAMPEONATO ECUATORIANO DE FÚTBOL - 2022 SEGUNDA ETAPA
# SCRIPT DE TODAS LAS JORNADAS SEGUNDA ETAPA
...
write.table(tjx,"tj1_15.txt",sep="\t",row.names=FALSE)
